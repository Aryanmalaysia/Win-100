    ...
    if (data) {
        if (data == 1) {
            ...
            if (check >= data && point_list.total1 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received RM ${point_list.total1}.00`,
                    status: true,
                    timeStamp: timeNow,
                });
            } else if (check < get && point_list.total1 != 0) {
                return res.status(200).json({
                    message: 'Please Recharge RM 300 to claim gift.',
                    status: false,
                    timeStamp: timeNow,
                });
        ...
        if (data == 2) {
            ...
            if (check >= get && point_list.total2 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received RM ${point_list.total2}.00`,
                    status: true,
                    timeStamp: timeNow,
                });
            } else if (check < get && point_list.total2 != 0) {
                return res.status(200).json({
                    message: 'Please Recharge RM 3000 to claim gift.',
                    status: false,
                    timeStamp: timeNow,
                });
        ...
        if (data == 3) {
            ...
            if (check >= get && point_list.total3 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received RM ${point_list.total3}.00`,
                    status: true,
                    timeStamp: timeNow,
                });
            } else if (check < get && point_list.total3 != 0) {
                return res.status(200).json({
                    message: 'Please Recharge RM 6000 to claim gift.',
                    status: false,
                    timeStamp: timeNow,
                });
        ...
        if (data == 4) {
            ...
            if (check >= get && point_list.total4 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received RM ${point_list.total4}.00`,
                    status: true,
                    timeStamp: timeNow,
                });
            } else if (check < get && point_list.total4 != 0) {
                return res.status(200).json({
                    message: 'Please Recharge RM 12000 to claim gift.',
                    status: false,
                    timeStamp: timeNow,
                });
        ...
        if (data == 5) {
            ...
            if (check >= get && point_list.total5 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received RM ${point_list.total5}.00`,
                    status: true,
                    timeStamp: timeNow,
                });
            } else if (check < get && point_list.total5 != 0) {
                return res.status(200).json({
                    message: 'Please Recharge RM 28000 to claim gift.',
                    status: false,
                    timeStamp: timeNow,
                });
        ...
        if (data == 6) {
            ...
            if (check >= get && point_list.total6 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received RM ${point_list.total6}.00`,
                    status: true,
                    timeStamp: timeNow,
                });
            } else if (check < get && point_list.total6 != 0) {
                return res.status(200).json({
                    message: 'Please Recharge RM 100000 to claim gift.',
                    status: false,
                    timeStamp: timeNow,
                });
        ...
        if (data == 7) {
            ...
            if (check >= get && point_list.total7 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received RM ${point_list.total7}.00`,
                    status: true,
                    timeStamp: timeNow,
                });
                ...
                return res.status(200).json({
                    message: 'Please Recharge RM200000 to claim gift.',
                    status: false,
                    timeStamp: timeNow,
                });
